...
-- Tiempo de generación: 07-03-2020 a las 07:55:06
...
DROP PROCEDURE IF EXISTS `USP_DECO_ACTUALIZAR_STOCK_ANULAR_INGRESO`$$
...
DROP PROCEDURE IF EXISTS `USP_DECO_ACTUALIZAR_STOCK_ANULAR_PRODUCCION`$$
...
DROP PROCEDURE IF EXISTS `USP_DECO_ACTUALIZAR_STOCK_ANULAR_VENTA`$$
